...
**Örnek olarak**:
\`\`\`${client.x.prefix}mute @üyeetiketi 1m merhaba
${client.x.prefix}mute 686185592899633200 1m merhaba\`\`\``));
...
**Örnek olarak**:
\`\`\`${client.x.prefix}mute @üyetiketi 1m merhaba\`\`\``));
...
.setColor('#00001')
.setTitle('Avethea - Chat Mute Sistem')
