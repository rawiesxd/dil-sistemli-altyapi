...
**Örnek olarak**:
\`\`\`${client.x.prefix}sesmute @üyeetiketi 1m merhaba
${client.x.prefix}sesmute 686185592899633200 1m merhaba\`\`\``));
...
**Örnek olarak**:
\`\`\`${client.x.prefix}sesmute @üyetiketi 1m merhaba\`\`\``));
...
.setColor('#00001')
.setTitle('Avethea - Sesli Mute Sistem')
...
message.guild.channels.cache.get(logChannel).send(new Discord.MessageEmbed()
.setTitle('Avethea - Sesli  Mute Sistem').setColor('#f1c335')
