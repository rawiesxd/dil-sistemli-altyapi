...
let link = `[Destek Sunucusu!](https://discord.gg/QU2yuzF)`
...
.addField(`Rol oluşturma:`, `\`${p}seviye-rol @rol <seviye>\``)
.addField(`Tüm rolleri silme:`, `\`${p}seviye-rol sıfırla\``)
.addField(`Ayarlanan Rolleri Görmek:`, `\`${p}seviye-rolleri\``)) 
}
      if(args[0] == 'temizle' || args[0] == "sıfırla") {
